...
Opening up the Internet Protocol you can see the source becomes the Linux VM and the destination is the Windows VM.
...
<p>
Next we are going to configure a fire wall. 
...
<p>
Now your rule has been added to the Inbound security rules. 
<p>
<img <img width="1440" alt="ACN_116" src="https://github.com/user-attachments/assets/aa70ca03-3fb2-4430-b05d-6cc9ffb018c6" />
</p>
<p>
Back in the Windows VM the pings will keep coming until the rule takes effect. 
...
<p>
If you go back to Wireshark instead of seeing request and reply you will only see request and no response found. 
<p>
<img <img width="1440" alt="ACN_119" src="https://github.com/user-attachments/assets/c661969c-3e99-476a-b460-811d6186fb0a" />
</p>
<p>
Now we are going to re-enable ICMP traffic in the network settings. 
...
<p>
From here we are going to Delete this rule 
...
<p> 
Now type in the password for the Linux vm user and press enter 
...
<p>
Now click "SSH Protocol", "SSH Version 2", and "Encrypted Packet". 
...
<p>
If you go back into Powershell and type "ls" and hit enter. 
<p>
<img <img width="1440" alt="ACN_167" src="https://github.com/user-attachments/assets/78f3ae4a-9e27-434a-90ca-63a4de223ea6" />
</p>
<p>
With the fact that ssh uses tcp port 22 you will see that traffic being filtered out. 
...
<p>
A better image for Wireshark showing from the windows computer to the linux computer that the packet was sent 
...
<p>
type "ipconfig /release" then underneath ipconfig /renew".     
<p>
...
<p>
In Powershell run ".\dhcp.bat" and press enter. 
...
<p>
When release from that script occured the release packet was sent from the Windows VM. 
...
<p>
Next we are going to observe dns traffic. 
...
<p>
The Non-authorative address is the one that dns.com resolves to. 
<p>
